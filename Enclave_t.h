...
void ecall_map(void);
void ecall_print(void);
void ecall_aes(void);
void ecall_encrypt(char* encMessageIn, size_t len, char* decMessageOut, size_t lenOut);
void ecall_decrypt(char* encMessageIn, size_t len, char* decMessageOut, size_t lenOut);
