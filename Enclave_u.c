...
sgx_status_t Enclave_ecall_type_char(sgx_enclave_id_t eid, char val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_type_int(sgx_enclave_id_t eid, int val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_type_float(sgx_enclave_id_t eid, float val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_type_double(sgx_enclave_id_t eid, double val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_type_size_t(sgx_enclave_id_t eid, size_t val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_type_wchar_t(sgx_enclave_id_t eid, wchar_t val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_type_struct(sgx_enclave_id_t eid, struct struct_foo_t val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_type_enum_union(sgx_enclave_id_t eid, enum enum_foo_t val1, union union_foo_t* val2)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_pointer_user_check(sgx_enclave_id_t eid, size_t* retval, void* val, size_t sz)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_pointer_in(sgx_enclave_id_t eid, int* val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_pointer_out(sgx_enclave_id_t eid, int* val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_pointer_in_out(sgx_enclave_id_t eid, int* val)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_pointer_string(sgx_enclave_id_t eid, char* str)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_pointer_string_const(sgx_enclave_id_t eid, const char* str)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_pointer_size(sgx_enclave_id_t eid, void* ptr, size_t len)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_pointer_count(sgx_enclave_id_t eid, int* arr, size_t cnt)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_pointer_isptr_readonly(sgx_enclave_id_t eid, buffer_t buf, size_t len)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ocall_pointer_attr(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_array_user_check(sgx_enclave_id_t eid, int arr[4])
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_array_in(sgx_enclave_id_t eid, int arr[4])
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_array_out(sgx_enclave_id_t eid, int arr[4])
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_array_in_out(sgx_enclave_id_t eid, int arr[4])
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_array_isary(sgx_enclave_id_t eid, array_t arr)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_function_public(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_function_private(sgx_enclave_id_t eid, int* retval)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_malloc_free(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_sgx_cpuid(sgx_enclave_id_t eid, int cpuinfo[4], int leaf)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_exception(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_map(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_print(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_aes(sgx_enclave_id_t eid)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_encrypt(sgx_enclave_id_t eid, char* encMessageIn, size_t len, char* decMessageOut, size_t lenOut)
{
	sgx_status_t status;
...
sgx_status_t Enclave_ecall_decrypt(sgx_enclave_id_t eid, char* encMessageIn, size_t len, char* decMessageOut, size_t lenOut)
{
	sgx_status_t status;
